...
import com.android.aquadelivery.adapters.PlaceYourOrderAdapter;
...
public class PlaceYourOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WaterModel restaurantModel = getIntent().getParcelableExtra("RestaurantModel");
    ...
    // calculate total00
    private void calculateTotalAmount(WaterModel restaurantModel) {
        ...
        tvSubtotalAmount.setText(currencySymbol + String.format("%.2f", subTotalAmount));

        if (isDeliveryOn) {
            tvDeliveryChargeAmount.setText(currencySymbol + String.format("%.2f", restaurantModel.getDelivery_charge()));
            subTotalAmount += restaurantModel.getDelivery_charge();
            tvDeliveryCharge.setVisibility(View.VISIBLE);  // Show the delivery charge label
            tvDeliveryChargeAmount.setVisibility(View.VISIBLE);  // Show the delivery charge amount
        } else {
            tvDeliveryCharge.setVisibility(View.GONE);  // Hide the delivery charge label
            tvDeliveryChargeAmount.setVisibility(View.GONE);  // Hide the delivery charge amount
        }

        tvTotalAmount.setText(currencySymbol + String.format("%.2f", subTotalAmount));
    }



    private void onPlaceOrderButtonClick(WaterModel restaurantModel) {
    ...
    private void initRecyclerView(WaterModel restaurantModel) {
